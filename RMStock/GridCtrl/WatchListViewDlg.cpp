...
// CWatchListViewDlg 대화 상자
//*******************************************************************/
//! Function Name : CWatchListViewDlg::CWatchListViewDlg(CWnd* pParent /*=NULL*/) : CDialogEx(CWatchListViewDlg::IDD, pParent)
//! Function      : 생성 초기 처리
...
//! Comment       : 
//******************************************************************/
CWatchListViewDlg::CWatchListViewDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CWatchListViewDlg::IDD, pParent)
{
	m_pParent = pParent;
	m_strScrNo = "9999";
	m_cellSelect.row = 0;
...
//*******************************************************************/
void CWatchListViewDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CWatchListViewDlg)
...
// BEGIN_MESSAGE_MAP
//*******************************************************************/
BEGIN_MESSAGE_MAP(CWatchListViewDlg, CDialogEx)
	ON_WM_PAINT()
	ON_WM_CLOSE()
	ON_WM_QUERYDRAGICON()
...
//! Return        : BOOL
//! Create        : , 2014/06/02
//! Comment       : CWatchListViewDlg 메시지 처리기
//******************************************************************/
BOOL CWatchListViewDlg::OnInitDialog()
{
...
//******************************************************************/
void CWatchListViewDlg::OnPaint()
{
	if (IsIconic())
	{
...
//! Comment       : 
//******************************************************************/
void CWatchListViewDlg::OnClose()
{
...
//!               : 이 함수를 호출합니다.
//******************************************************************/
HCURSOR CWatchListViewDlg::OnQueryDragIcon()
{
...
//! Comment       : 
//******************************************************************/
void CWatchListViewDlg::OnBtnJongAdd()
{
...
//! Comment       : 
//******************************************************************/
void CWatchListViewDlg::OnBtnJongDelete()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
//! Comment       : 
//******************************************************************/
void CWatchListViewDlg::OnBtnJongAllDelete()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
//! Comment       : 
//******************************************************************/
void CWatchListViewDlg::OnBtnSearch()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	m_cellSelect.row = 0;
	m_cellSelect.col = 0;
...
//! Comment       : 
//******************************************************************/
void CWatchListViewDlg::InitKwanSimGrid()
{
...
//! Comment       : 
//******************************************************************/
void CWatchListViewDlg::SetKwanSimJong()
{
	CString strFileName = theApp.m_sAppPath + "/data/kwansim.ini";
...
//! Comment       : 
//******************************************************************/
void CWatchListViewDlg::SendJongSearch(int nCodeCount/* = 0*/, CString strCodeList/* = ""*/)
{
...
//! Comment       : 
//******************************************************************/
void CWatchListViewDlg::OnReceiveTrDataKhopenapictrl(LPCTSTR sScrNo, LPCTSTR sRQName, LPCTSTR sTrcode, LPCTSTR sRecordName, LPCTSTR sPrevNext, long nDataLength, LPCTSTR sErrorCode, LPCTSTR sMessage, LPCTSTR sSplmMsg)
{
...
//! Comment       : 
//******************************************************************/
void CWatchListViewDlg::OnReceiveMsgKhopenapictrl(LPCTSTR sScrNo, LPCTSTR sRQName, LPCTSTR sTrCode, LPCTSTR sMsg)
{
}
...
//! Comment       : 
//******************************************************************/
void CWatchListViewDlg::OnReceiveRealDataKhopenapictrl(LPCTSTR sJongmokCode, LPCTSTR sRealType, LPCTSTR sRealData)
{
	CString strIndex;
...
//! Comment       : 
//******************************************************************/
void CWatchListViewDlg::OnReceiveChejanData(LPCTSTR sGubun, LONG nItemCnt, LPCTSTR sFidList)
{
...
//! Comment       : 
//******************************************************************/
void CWatchListViewDlg::SetDataKwanSimGrid(CStringArray &arrData, CString strRealType/* = ""*/)
{
	// 종목코드에 맞는 행 찾기
